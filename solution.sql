...
SET transactions_attempted= '1', account_balance = '10.00'
...
SELECT username FROM syntax_practice ORDER BY account_balance DESC
 LIMIT 3;
...
('Katie', 'Minneapolis', '4', '6', '752.32')


(NOTE:  Did not have to include information regarding user_id because that is the PRIMARY KEY and will auto-increment.)
